  ...
  return (
    <form>
      ...
      <div className='w-3/5 mx-auto flex flex-col  gap-5'>
        <div>
          <p className='text-xl text=[#060237]'>{data.brand}</p>
          <input className='h-12 p-4 mt-2 w-full  border-2 border-[#060337] rounded-full' type="text" />
        </div>
        <div>
          <p className='text-xl text=[#060237]'>{data.name}</p>
          <input className='h-12 p-4 mt-2 w-full  border-2 border-[#060337] rounded-full' type="text" />
        </div>
        <div>
          <p className='text-xl text=[#060237]'>{data.webUrl}</p>
          <input className='h-12 p-4 mt-2 w-full  border-2 border-[#060337] rounded-full' type="text" />
        </div>
        <div>
          <p className='text-xl text=[#060237]'>{data.email}</p>
          <input className='h-12 p-4 mt-2 w-full  border-2 border-[#060337] rounded-full' type="email" />
        </div>
        <div>
          <p className='text-xl text=[#060237]'>{data.phoneNo}</p>
          <div>
        ...
        <div>
          <div>
            <p className='text-xl text=[#060237] mt-5'>{data.salary}</p>
            ...
            <div>
              <p className='text-xl text=[#060237]'>{data.converstionRate}</p>
              <input className='h-12 p-4 mt-2 w-full  border-2 border-[#060337] rounded-full' type="text" />
            </div>

            <div className='mt-5'>
              <p className='text-xl text=[#060237]'>{data.issue}</p>
          ...
          <div className='mt-3'>
            <p className='text-xl my-2   text=[#060237]'>{data.overview}</p>
